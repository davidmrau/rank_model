...
# instanitae model
net = ScoreModel([512, 512], embedding_weights, 300, 400002, 0.2, compostionality_weights, trainable_weights=True)


# instantiate Data Reader
READER_TEST = DataReader(DATA_FILE_TEST, 1, False, id2q, id2d, NUM_HIDDEN_NODES, MAX_DOC_TERMS, MAX_QUERY_TERMS, DATA_FILE_VOCAB, DATA_EMBEDDINGS, MB_SIZE)
READER_TRAIN = DataReader(DATA_FILE_TRAIN, 2, True, id2q, id2d, NUM_HIDDEN_NODES, MAX_DOC_TERMS, MAX_QUERY_TERMS, DATA_FILE_VOCAB, DATA_EMBEDDINGS, MB_SIZE)
...
for ep_idx in range(NUM_EPOCHS):
	...
	for mb_idx in range(EPOCH_SIZE):
		...
		print_message('examples:{}, loss:{}, acc:{}'.format(total_examples_seen, loss, acc))
